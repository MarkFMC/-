...
def challenge_result(team_name1="Мастера кода", team_name2="Волшебники Данных"):
    if score1 < score2 or score1 == score2 and team1_time < team2_time:
        return f"{team_name1}!"
    else:
        return f"{team_name2}"

print("В команде Мастера кода участников: %s ! " % int(team1_num - 1))
print("Итого сегодня в командах участников: %s и %s !" % (int(team1_num - 1), team2_num))
print("Команда Волшебники данных решила задач: {} !".format(score2))
print("Волшебники данных решили задачи за {} с !".format(round(team1_time+16462.69, 2)))
